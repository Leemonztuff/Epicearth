...
import { InventorySlot, EquipmentSlot, EquipmentSlotState, ItemDefinition } from '../../lib/game/types';
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-2 border border-slate-800/50">
                    ...
                    <div className="text-xs font-bold text-slate-200">{getTotalWeight()}/2000</div>
                  </div>
                  <div className="bg-slate-900/50 rounded-lg p-2 border border-slate-800/50">
                    <div className="text-[9px] text-slate-500 font-mono">ZENY</div>
                    <div className="text-xs font-bold text-amber-400">5,000</div>
                  </div>
                </div>
                  ...
                  {inventorySlots.map((slot, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`aspect-square rounded-lg border transition-all flex flex-col items-center justify-center ${
                          slot && itemDef
